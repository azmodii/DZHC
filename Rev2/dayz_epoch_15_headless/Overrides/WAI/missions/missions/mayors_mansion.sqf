...
[_position,"Mayors Mansion"] execVM "DZHC\Overrides\WAI\missions\compile\markers.sqf";
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"The rogue mayor has been taken out, who will be the next Mayor of Napf?", "PLAIN",10] call RE;
} else {
