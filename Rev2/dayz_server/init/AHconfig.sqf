...
/* *********************************www.infiSTAR.de********************************* */
/*  Key to open the menu  */ _OpenMenuKey = 0x46;    /* google DIK_KeyCodes (0x3C is F2) */
/*  LOW ADMIN HERE        */ _LowLevel_List =   []; //do not have a , at the end.
/*  NORMAL ADMIN HERE     */ _NormalLevel_List =[]; //do not have a , at the end.
/*  SUPER ADMIN HERE      */ _SuperLevel_List = ["11313728","5291968","136513862","67371526","38095494","3453824","130501702","130501702","29275846","88664710"]; //do not have a , at the end.
/*  BANNED PLAYER HERE    */ _BLOCKED =         []; //do not have a , at the end.
/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = 'GSGaming.com.au'; //do not use ' or " in this text.
/*  Bottom esc menu TXT   */ _LowerTop = 'TS: ts.gsgaming.com.au'; //do not use ' or " in this text.
/*  Bottom esc menu TXT2  */ _LowerBottom = 'Server IP: 119.252.191.21'; //do not use ' or " in this text.
/*  Color esc menu TXT    */ _EscColor = [0.6,0,0,1];
/*  DebugMonitor TXT      */ _BottomDebug = 'Thanks for all the blood!'; //do not use ' or " in this text.
...
[
	...
	"BTC_Hud","#USER:newspawn","#USER:classes","#USER:Page4","#USER:Donator","#USER:Peasant"
];
/* ********************************************************************************* */
